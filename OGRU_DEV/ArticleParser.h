...
//  OGRU_DEV
//
//  Created by yu chihchung on 2012-07-17.
//  Copyright (c) 2012年 __MyCompanyName__. All rights reserved.
//

#import <Foundation/Foundation.h>
@class ArticleParser, ArticleModel;
...
- (void)parser:(ArticleParser *)parser didParseIndex:(NSArray *)parsedArticles;

@end
@interface ArticleParser : NSObject<NSXMLParserDelegate>
{
    __unsafe_unretained id <ArticleParserDelegate> delegate;
...
- (void)startWithArticleID:(NSString*)articleID;
