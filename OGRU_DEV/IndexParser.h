...
@class IndexParser, ArticleModel;
@protocol IndexParserDelegate <NSObject>
...
@end
@interface IndexParser : NSObject<NSXMLParserDelegate>
{
    __unsafe_unretained id <IndexParserDelegate> delegate;
...
@property  (nonatomic,assign) id <IndexParserDelegate> delegate;
